...
export const HOSPITAL_ACCOUNTS: HospitalAccount[] = [
  {
    ...
    email: "dispatch@gmch.demo",
    password: "hospital123",
    contactName: "GMCH Trauma Desk",
  },
  {
    id: "staff-mmch",
    hospitalId: "govt-mmch-civil",
    hospitalName: "MMCH District Civil Hospital",
    email: "dispatch@mmch.demo",
    password: "hospital123",
    contactName: "MMCH Emergency Desk",
  },
  {
    id: "staff-hayat",
    hospitalId: "pvt-hayat-hospital",
    hospitalName: "Hayat Super Specialty Hospital",
    email: "dispatch@hayat.demo",
    password: "hospital123",
    contactName: "Hayat Dispatch Desk",
  },
  {
    id: "staff-gnrc",
    hospitalId: "pvt-gnrc-dispur",
    hospitalName: "GNRC Super-Specialty Hospital",
    email: "dispatch@gnrc.demo",
    password: "hospital123",
    contactName: "GNRC Trauma Desk",
  },
];
