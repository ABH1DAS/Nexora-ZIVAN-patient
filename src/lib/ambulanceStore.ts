...
export const INITIAL_DEMO_REQUESTS: AmbulanceRequest[] = [
  ...
  },
  {
    ...
    locationLabel: "Paltan Bazar Station Rd · Emergency Call",
    coordinates: { lat: 26.1785, lng: 91.7510 },
    hospitalId: "govt-mmch-civil",
    hospitalName: "MMCH District Civil Hospital",
    hospitalCategory: "government",
    status: "PENDING",
    priority: "urgent",
    ambulanceType: "government",
  ...
  },
  {
    ...
    patientName: "Bikash Borah",
    patientPhone: "+91 98333 77889",
    locationLabel: "Kahilipara Main Rd, Lal Ganesh · SOS App",
    coordinates: { lat: 26.1512, lng: 91.7820 },
    hospitalId: "pvt-hayat-hospital",
    hospitalName: "Hayat Super Specialty Hospital",
    hospitalCategory: "private",
    status: "REQUEST RECEIVED",
    priority: "standard",
    ambulanceType: "private",
    doctorSpecialization: "Neurology",
    notes: "64yo male acute dizziness and hemiparesis. Immediate stroke triage required.",
    bloodGroup: "A+",
    etaMinutes: 9,
    icuRequirement: true,
  },
